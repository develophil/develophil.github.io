...
keep_prob = 0.6  # dropout할 때 keep할 비율
...
# 데이터를 로딩한다.
stock_dict = get_stock_dictionary('2018-11-09') # 11-06 예측을 위한 데이터 훈련
print('data length : {}'.format(len(stock_dict)))


for i, code in enumerate(stock_dict):
    print('stocke code : {}'.format(code))
